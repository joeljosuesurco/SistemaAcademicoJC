  ...
  <div class="p-6 space-y-6">
    ...
    <div v-if="!estudianteSeleccionado">
      ...
      <table v-else class="w-full text-left bg-white rounded shadow">
        ...
        <tbody>
          <tr v-for="est in estudiantesPaginados" :key="est.id_estudiante" class="even:bg-gray-50">
    ...
    <div v-else>
      ...
      <div class="p-4 bg-orange-50 border border-orange-200 rounded-xl shadow-md">
        ...
        <p><strong>Nivel Educativo:</strong> {{ estudianteSeleccionado.nivel_educativo.nombre }}</p>
        <div class="mt-4">
