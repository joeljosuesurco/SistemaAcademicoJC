  ...
  try {
    for (const e of estudiantes.value) {
      const payload = {
        ...
        numero_periodo: numeroPeriodo.value,
        dimensiones: [
          { nombre_dimension: 'ser_docente', valor_obtenido: e.ser },
          { nombre_dimension: 'saber_docente', valor_obtenido: e.saber },
          { nombre_dimension: 'hacer_docente', valor_obtenido: e.hacer },
          { nombre_dimension: 'decidir_docente', valor_obtenido: e.decidir },
          { nombre_dimension: 'ser_autoeval', valor_obtenido: e.ser_auto },
          { nombre_dimension: 'decidir_autoeval', valor_obtenido: e.decidir_auto },
        ],
      }
